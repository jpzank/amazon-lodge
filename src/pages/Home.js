      ...
      <section className="relative h-screen w-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 top-24 flex items-start justify-center px-4">
          <div className="relative">
            ...
            <div className="absolute inset-0 -m-6 bg-black/10 backdrop-blur-sm rounded-3xl"></div>
            <img
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto relative">
              {/* Opening Quote Mark */}
              <div className="absolute -left-8 -top-8 text-8xl text-primary/20 font-serif leading-none">
                "
              </div>
              {/* Closing Quote Mark */}
              <div className="absolute -right-8 -bottom-4 text-8xl text-primary/20 font-serif leading-none">
                "
              </div>
              {/* Testimonials Container */}
              <div className="relative h-auto min-h-[280px] md:h-[200px] mb-16">
