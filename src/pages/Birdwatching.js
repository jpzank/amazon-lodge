...
const Birdwatching = () => {
  ...
  return (
    <>
      <SEO 
        title={t('meta.birdwatching.title')}
        description={t('meta.birdwatching.description')}
        image="https://res.cloudinary.com/dxlhv2mji/image/upload/v1738450243/tie_bicudo_jh_hfnk4c.jpg"
      />
