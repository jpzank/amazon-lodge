...
const Primatas = () => {
  ...
  return (
    <>
      <SEO 
        title={t('meta.primatas.title')}
        description={t('meta.primatas.description')}
        image="https://res.cloudinary.com/dxlhv2mji/image/upload/v1739857960/macaco-cara-preta_ilsz9z.jpg"
      />
