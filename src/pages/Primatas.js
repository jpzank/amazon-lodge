    ...
    <div className="min-h-screen bg-white">
      <div className="relative min-h-[60vh] flex items-center justify-center" style={heroStyle}>
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <p className="text-xl md:text-2xl">Uma aventura em busca de importantes primatas da região sul da Amazônia</p>
        </div>
      </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-4xl font-bold text-center mb-16">Espécies Emblemáticas</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="relative h-64" style={zogueZogueStyle}>
                <span className="absolute top-4 right-4 px-2 py-1 text-sm font-semibold text-white bg-red-500 rounded">CR</span>
              </div>
              <div className="p-6 space-y-4">
                <h3 className="text-2xl font-semibold">Zogue-zogue-do-mato-grosso</h3>
                <p className="text-lg text-gray-600 italic">Plecturocebus grovesi</p>
                <p className="text-gray-500">Mato Grosso Titi Monkey</p>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="relative h-64" style={{ backgroundImage: `url('src/images/birdwatching/parauacu.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <span className="absolute top-4 right-4 px-2 py-1 text-sm font-semibold text-white bg-yellow-500 rounded">VU</span>
              </div>
              <div className="p-6 space-y-4">
                <h3 className="text-2xl font-semibold">Parauacu</h3>
                <p className="text-lg text-gray-600 italic">Pithecia mittermeieri</p>
                <p className="text-gray-500">Tapajo's Saki Monkey</p>
                <p className="text-gray-700">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="relative h-64" style={{ backgroundImage: `url('src/images/birdwatching/macaco-aranha.jpg')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                <span className="absolute top-4 right-4 px-2 py-1 text-sm font-semibold text-white bg-yellow-500 rounded">VU</span>
              </div>
              <div className="p-6 space-y-4">
                <h3 className="text-2xl font-semibold">Macaco-aranha-da-cara-preta</h3>
                <p className="text-lg text-gray-600 italic">Ateles chamek</p>
                <p className="text-gray-500">Black-faced Spider Monkey</p>
                <p className="text-gray-700">
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-bold text-center mb-12">Nossos Roteiros Incluem</h2>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-bold text-center mb-12">Opcional: Aldeia Parecis</h2>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-primary/5 rounded-2xl p-8">
              <h3 className="text-2xl font-semibold mb-6">Melhor Época</h3>
              <p className="text-lg text-gray-700 leading-relaxed">
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-bold text-center mb-12">Macaquear no Mato Grosso</h2>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-bold text-center mb-12">Rota de Primatas do Mato Grosso</h2>
          <div className="space-y-8">
            ...
            <div className="bg-primary/5 rounded-2xl p-8">
              <h3 className="text-2xl font-semibold mb-6">Sobre a Rota</h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h4 className="text-xl font-semibold mb-3">Destinos</h4>
                  <p className="text-lg text-gray-700">São José do Rio Claro • Sinop • Alta Floresta</p>
                </div>
                <div>
                  <h4 className="text-xl font-semibold mb-3">Benefícios</h4>
                  <p className="text-lg text-gray-700">Ciência cidadã • Pesquisa acadêmica • Turismo sustentável • Renda local</p>
                </div>
              </div>
            </div>
